...
class FaceMeshMediapipe:
    def __init__(self):
        ...
        self.config_draw = self.mp_draw.DrawingSpec(color=(0, 127, 255), thickness=1, circle_radius=1)
    ...
    def check_face_center(self, face_points: List[List[int]]) -> bool:
        if len(face_points) == 468:
            ...
            # si la ceja derecha es mayor que el parietal derecho y
            # la ceja izquierda es menor que el parietal izquierdo
